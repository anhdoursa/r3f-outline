import { ArcballControls, Bounds, Environment, GizmoHelper, GizmoViewport, Lightformer } from "@react-three/drei"
...
export default function App() {
  return (
    <Canvas orthographic dpr={[1, 2]} camera={{ position: [0, 0, 130], fov: 35, near: 1, far: 20 }}>
